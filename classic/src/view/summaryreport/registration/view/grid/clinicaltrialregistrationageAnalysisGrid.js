Ext.define('Admin.view.summaryreport.registration.view.grid.ClinicalTrialRegistrationAgeAnalysisGrid', {
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                pageSize: 100,
                storeId: 'clinicaltrialregistrationAgeAnalysisStr',
                groupField: 'SubModule',
                proxy: {
                    url: 'summaryreport/getClinicalTrialRegistrationAgeAnalysisReport'
                }
            },
            isLoad: false
        },
