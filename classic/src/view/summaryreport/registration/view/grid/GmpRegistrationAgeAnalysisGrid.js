Ext.define('Admin.view.summaryreport.registration.view.grid.GmpRegistrationAgeAnalysisGrid', {
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                pageSize: 100,
                storeId: 'gmpregistrationAgeAnalysisStr',
                groupField: 'SubModule',
                proxy: {
                    url: 'summaryreport/getGmpRegistrationAgeAnalysisReport'
                }
            },
            isLoad: false
        },
