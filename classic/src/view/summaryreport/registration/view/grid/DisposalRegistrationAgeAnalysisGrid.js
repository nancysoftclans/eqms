Ext.define('Admin.view.summaryreport.registration.view.grid.DisposalRegistrationAgeAnalysisGrid', {
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                pageSize: 100,
                storeId: 'disposalregistrationAgeAnalysisStr',
                groupField: 'SubModule',
                proxy: {
                    url: 'summaryreport/getDisposalRegistrationAgeAnalysisReport'
                }
            },
            isLoad: false
        },
