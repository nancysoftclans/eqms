Ext.define('Admin.view.summaryreport.registration.view.panel.PromAdvertRegistrationReportPnl', {
  ...
  bbar: [{
        ...
        items: [
        {
            ...
            handler: 'printPromAdvertRegSummaryReport',
        },
        '->',
        {
            xtype: 'combo',
          ...
          xFileName: 'promadvertSummaryReport',
          module: 'promadvert',
          xPrintFunc: 'exportpromadvertDefinedColumns',
          xheading:'promotion and advertisement Application Summary Report',
          margin: '0 ,0 ,0 ,0',
        },'->',{
            text: 'Export Detailed Report',
            handler: 'func_ExpWinShow',
            childXtype: 'detailedPromAdvertRegistrationReportExportFrm',
            winTitle: 'Export Detailed Report',
            name: 'DetailedExport',
            module: 'promadvertWin',
            winWidth: '70%',
