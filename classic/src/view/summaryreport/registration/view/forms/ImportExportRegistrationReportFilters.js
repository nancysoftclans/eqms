...
Ext.define('Admin.view.summaryreport.registration.form.ImportExportRegistrationReportFilters', {
            ...
            defaults: {
              ...
              items:[{
                ...
                },
                {
                    ...
                    handler: 'func_LoadImportExportReportFilters',
                    formBind: true,
                }
		       ]
            }
