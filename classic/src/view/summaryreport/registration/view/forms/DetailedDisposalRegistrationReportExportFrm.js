Ext.define('Admin.view.summaryreport.application.form.DetailedDisposalRegistrationReportExportFrm', {
	extend: 'Ext.form.Panel',
	xtype: 'detailedDisposalRegistrationReportExportFrm',
	margin: 2,
	height: 500,
	layout: 'fit',
    ...
    items: [{
            ...
            xtype: 'textfield',
            name: 'action_url',
            value: 'exportDisposalDefinedColumns',
            hidden: true
        },{
            xtype: 'textfield',
            name: 'zone_id',
