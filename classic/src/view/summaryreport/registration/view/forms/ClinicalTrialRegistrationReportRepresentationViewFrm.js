Ext.define('Admin.view.summaryreport.registration.form.ClinicalTrialRegistrationReportRepresentationViewFrm', {
        ...
        items: [
          {
        	...
        	listeners: {
			        beforerender: {
			            ...
			            config: {
			                ...
			                storeId: 'ClinicalTrialRegistrationReportStr',
			                proxy: {
			                    url: 'summaryreport/getClinicalTrialGridRegistrationReport',
			                    extraParams: {
			                            module_id: 7
			                        }
			                }
        	...
        	columns: [{
                ...
                text: 'Clinical Product Category',
                sortable: false,
                flex: 1,
        	...
        	items: [{
			        ...
			        listeners: {
				        beforerender: {
				            ...
				            config: {
				                pageSize: 1000,
				                storeId: 'ClinicalTrialRegistrationReportCartesianStr',
				                proxy: {
				                    url: 'summaryreport/getClinicalTrialRegistrationCartesianReport',
				                    extraParams: {
			                           module_id: 7
			                        }
				                }
			        ...
			        series: [{
			            ...
			            tooltip:{ 
							  ...
							  renderer:function(toolTip, storeItem, item){
							    toolTip.setHtml(storeItem.get(item.field).toFixed(1)+' '+item.field+ ' for '+storeItem.get('clinical_category') );
							  }
                         }
			        }]
                }],
