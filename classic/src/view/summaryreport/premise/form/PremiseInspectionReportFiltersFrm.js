...
Ext.define('Admin.view.summaryreport.premise.form.PremiseInspectionReportFiltersFrm', {
                        ...
                        beforerender: {
                           ...
                           config: {
                                ...
                                extraParams: {
                                    ...
                                    filters: JSON.stringify({'description':'receiving'})
                                }
                               }
                            },
                            isLoad: true
                    ...
                    listeners: {
                        beforerender: {
                           ...
                           config: {
                                ...
                                extraParams: {
                                    table_name: 'par_appprocess_definations',
                                    filters: JSON.stringify({'description':'permit'})
                                }
                               }
                            },
                            isLoad: true
