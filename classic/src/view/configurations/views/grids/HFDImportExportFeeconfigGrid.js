...
Ext.define('Admin.view.configurations.views.grids.HFDImportExportFeeconfigGrid', {
    ...
    tbar: [{
        ...
        action: 'add',
        ui: 'soft-blue',
        childXtype: 'hfdimportexportfeeconfigfrm',
        winTitle: 'HFD Import/Export Fee Configurations',
        winWidth: '70%',
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                pageSize: 100,
                storeId: 'hfdimportExportfeeconfigstr',
                groupField:'fee_type',
                proxy: {
