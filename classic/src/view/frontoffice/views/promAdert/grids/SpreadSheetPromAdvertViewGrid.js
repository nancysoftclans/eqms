 Ext.define('Admin.view.frontoffice.promAdvert.grids.SpreadSheetPromAdvertViewGrid', {
   ...
   plugins: [{
    ...
    },
    {
    ...
    },
     {
        ...
        text: 'Customer Physical Address',
        width: 210, hidden: true,
        filter: {
                xtype: 'textfield',
            }
