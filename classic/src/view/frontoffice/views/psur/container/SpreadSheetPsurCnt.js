Ext.define('Admin.view.frontoffice.psur.container.SpreadSheetPsurCnt', {
    extend: 'Ext.form.Panel',
    xtype: 'spreadSheetPsurCnt',
    layout:'border',
    controller: 'spreadSheetPsurVctr',
            tbar: [ 
               {
                    xtype: 'combobox',
                    forceSelection: true,
               ...
               items: [{
                  ...
                  items: [
                  {
                    ...
                    xtype: 'psurAdditionalFiltersFrm',
                    height: 200,
                    region: 'south'
                   }
               ]
