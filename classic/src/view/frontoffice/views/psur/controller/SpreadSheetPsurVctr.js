var premise_type_id="";
var sub_module="";
Ext.define('Admin.view.openOffice.Revenue.controller.SpreadSheetPsurVctr', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.spreadSheetPsurVctr',
         ...
         setGridStore: function (obj, options) {
          ...
          func_showhideSpreasheetColumn: function (chk, value) {
                  ...
                  var grid =this.lookupReference('psurViewGridpanel');
