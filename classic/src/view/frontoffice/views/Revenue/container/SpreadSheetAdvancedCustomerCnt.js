Ext.define('Admin.view.frontoffice.Revenue.container.SpreadSheetAdvancedCustomerCnt', {
    extend: 'Ext.form.Panel',
    xtype: 'spreadSheetAdvancedCustomerCnt',
    layout:'border',
    controller: 'spreadSheetAdvanceVctr',
            tbar: [ 
               {
                    xtype: 'combobox',
                    forceSelection: true,
