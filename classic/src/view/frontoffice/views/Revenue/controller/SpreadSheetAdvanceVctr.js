var premise_type_id="";
var sub_module="";
Ext.define('Admin.view.openOffice.Revenue.controller.SpreadSheetAdvanceVctr', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.spreadSheetAdvanceVctr',
         ...
         setGridStore: function (obj, options) {
          ...
          func_showhideSpreasheetColumn: function (chk, value) {
                  ...
                  var grid =this.lookupReference('advancedcustomergridpanel');
             ...
             func_exportpremisespreadsheet: function (btn) {
                 ...
                 var name=btn.name;
                  ...
                  var header2=[];
                   ...
                   xheading = 'ADVANCED CUSTOMERS APPLICATIONS SPREADSHEET';
