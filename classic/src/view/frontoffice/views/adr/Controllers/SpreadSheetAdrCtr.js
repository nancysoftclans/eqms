var premise_type_id="";
var sub_module="";
Ext.define('Admin.view.openOffice.adr.Controller.SpreadSheetAdrCtr', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.spreadSheetAdrCtr',
         ...
         setGridStore: function (obj, options) {
          ...
          loadadditionalinfo:  function(sender,record) {
              var pvid=record.data['pv_id'];
              var filter = { 't1.pv_id':pvid };
              var   filters = JSON.stringify(filter);
              // var grid =this.lookupReference('adrDrugInfogrid'),
              //  Gridstore=grid.getStore();
              //  Gridstore.removeAll();
              //  Gridstore.load();
              //  Gridstore.reload({params:{filters:filters}});
               Ext.data.StoreManager.lookup('spreadsheetadrsuspecteddruginfostr').reload({params:{filters:filters}});
          ...
          func_showhideSpreasheetColumn: function (chk, value) {
                  ...
                  var grid =this.lookupReference('adrgridpanel');
