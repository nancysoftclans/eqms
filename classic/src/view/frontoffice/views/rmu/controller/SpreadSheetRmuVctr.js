var premise_type_id="";
var sub_module="";
Ext.define('Admin.view.openOffice.mir.Controller.SpreadSheetRmuVctr', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.spreadSheetRmuVctr',
         ...
         setGridStore: function (obj, options) {
          ...
          loadadditionalinfo:  function(sender,record) {
              ...
              var   filters = JSON.stringify(filter);
               Ext.data.StoreManager.lookup('spreadsheetrmuresponseinforstr').reload({params:{filters:filters}});
          ...
          func_showhideSpreasheetColumn: function (chk, value) {
                  ...
                  var grid =this.lookupReference('rmuViewGridpanel');
