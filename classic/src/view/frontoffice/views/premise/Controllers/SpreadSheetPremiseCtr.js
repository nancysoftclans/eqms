    ...
    alias: 'controller.spreadsheetpremisectr',
         ...
         setGridStore: function (obj, options) {
          ...
          loadadditionalinfo:  function(sender,record) {
              ...
              var   filters = JSON.stringify(filter);
              // var form =this.lookupReference('premisebsninfo'),
              //  BsnTypestore=form.getStore();
    
              //  BsnTypestore.removeAll();
              //  BsnTypestore.load();
              //  var form2 =this.lookupReference('premisepersonnelinfo'),
              //  BsnTypestore2=form2.getStore();
              //  BsnTypestore2.removeAll();
              //  BsnTypestore2.load();
              //  BsnTypestore2.reload({params:{filters:filters}});
              //  BsnTypestore2.reload({params:{filters:filters}});
