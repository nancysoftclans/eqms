Ext.define('Admin.view.reports.appsreports.enforcementreport.grid.DetailedEnforcementViewgrid', {
    extend: 'Ext.grid.Panel',  
      scroll: true,
      width: '150%',
      xtype: 'detailedEnforcementViewgrid',
      itemId:'spreadsheetgrid',
      layout: 'fit',
      store: 'spreadsheetpromadvertcolumnsstr',
       title: 'Enforcement report Application Detailed Report',
