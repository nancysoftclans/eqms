Ext.define('Admin.view.reports.appsreports.surveillancereport.grid.DetailedSurveillanceViewGrid', {
    extend: 'Ext.grid.Panel',  
      scroll: true,
      width: '100%',
       xtype: 'detailedSurveillanceViewGrid',
       layout: 'fit',
       title: 'Survelliance Application Report',
       referenceHolder: true,
      reference:'detailedsurvelliancegridpanel',
      plugins: [{
               ptype: 'filterfield'
           }],
       viewConfig: {
