Ext.define('Admin.view.reports.appsreports.surveillancereport.grid.SurveillancetabularrepresentationGrid', {
    extend: 'Ext.grid.Panel',
    controller: 'productreportctr',
    xtype: 'surveillancetabularrepresentationGrid',
    itemId:'surveillancetabularrepresentationGrid',
    autoScroll: true,
    autoHeight: true,
    width: '100%',
    export_title:'Surveillance report Summary',
    viewConfig: {
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                ...
                storeId: 'surveillancetabularrepresentationgridstr',
                proxy: {
                    url: 'newreports/getSurveillanceSummaryReport',
                    extraParams: {
                        module_id: 5
                        }
                    }
