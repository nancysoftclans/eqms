Ext.define('Admin.view.plugins.Filterfield', {
    extend: 'Ext.AbstractPlugin',
    alias: 'plugin.filterfield',
    pluginId: 'filterfield',

    require: [
        'Admin.view.plugins.OperatorButton'
    ],
    ...
    applyFilter: function (field) {
		...
		getgridFilters: function (grid) {
			var filters = grid.getStore().getFilters().getRange();
			return filters;
