Ext.define('Admin.view.migrations.views.grids.ComplementaryMedicinesApplicationsGrd', {
        ...
        beforerender: {
            ...
            config: {
                ...
                proxy: {
                    ...
                    url : 'migrations/getcomplementarymedicinesapplications',
                }
            },
            isLoad: true
        },
    ...
    },
    {
        xtype : 'button',
        ui : 'blue',
        text : 'import records from exel file',
