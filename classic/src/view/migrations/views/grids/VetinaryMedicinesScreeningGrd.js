Ext.define('Admin.view.migrations.views.grids.VetinaryMedicinesScreeningGrd.js',{
        ...
        beforerender: {
            ...
            config: {
                ...
                proxy: {
                    ...
                    url : 'migrations/getvetinarymedsscreeningregister',
                }
            },
            isLoad: true
        },
    ...
    tbar : [{
        ...
        handler : 'savedirtydataforvetinarymedicinesscreening',
