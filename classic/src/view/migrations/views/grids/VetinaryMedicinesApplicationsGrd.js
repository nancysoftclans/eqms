Ext.define('Admin.view.migrations.views.grids.VetinaryMedicinesApplicationsGrd.js',{


    extend: 'Ext.grid.Panel',
    xtype: 'vetinarymedicinesapplicationgrd',
    itemId : 'vetinarymedicinesapplicationgrd',
        ...
        beforerender: {
            ...
            config: {
                ...
                proxy: {
                    ...
                    url : 'migrations/getvetinarymedicinesapplicationsregister'
                }
            },
            isLoad: true
        },
    ...
    tbar : [{
        ...
        handler : 'savedirtydataforvetmedicinesapplications',
