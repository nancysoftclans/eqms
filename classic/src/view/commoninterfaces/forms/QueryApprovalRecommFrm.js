 ...
 */
Ext.define('Admin.view.commoninterfaces.forms.QueryApprovalRecommFrm', {
    extend: 'Ext.form.Panel',
    xtype: 'queryApprovalRecommFrm',
    itemId: 'queryApprovalRecommFrmId',
    ...
    dockedItems:[
        {
            ...
            items:[{
                ...
                margin: '20 0 0 0',
                formBind: true,
                callerPnl: 'queryApprovalRecommFrmId', //item id for reference, all calls are done from widget with itemId
