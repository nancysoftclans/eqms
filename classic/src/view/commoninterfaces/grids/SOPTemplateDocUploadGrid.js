Ext.define('Admin.view.commoninterfaces.grids.SOPTemplateDocUploadGrid', {
    extend: 'Ext.tree.Panel',
    controller: 'commoninterfacesVctr',
    xtype: 'soptemplatedocuploadgrid',
    useArrows: true,
    rootVisible: false,
    multiSelect: false,
    singleExpand: true,
    ...
    bbar: [{
        ...
        emptyMsg: 'No Records',
        beforeLoad: function () {
            this.up('soptemplatedocuploadgrid').fireEvent('refresh', this);
        }
    }],
    autoScroll: true,
    selModel:{
