 ...
 */
Ext.define('Admin.view.documentManager.views.panels.LogDatabasesReceivingPnl',{
    extend: 'Ext.panel.Panel',
    alias: 'widget.logdatabasesreceivingpnl',
    padding: '2 0 2 0',
    requires: [
        ...
        this.tbar = {
            ...
            items: [
                
                {
                    ...
                    enableToggle: true,
                    pressed: true,
                    text: 'Log Databases Application Details',
                    max_step:1,
                    action: 'quickNav', wizard: 'logdatabasesreceivingpnl',
                    ...
                    enableToggle: true,
                    max_step:1,
                    text: 'Log Databases Upload',
                    action: 'quickNav', 
                    wizard: 'logdatabasesreceivingpnl',
                    handler: 'quickNavigation'
                }
            ]
        };
            ...
            items: [
                ...
                '->',
                {
                   ...
                   // formBind: true,
                    ...
                    wizard: 'logdatabasesreceivingpnl',
                    handler: 'saveLogDBApplicationReceivingBaseDetails'
                },
                {
