 ...
 */
Ext.define('Admin.view.documentManager.views.panels.DocumentRenewalWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.documentrenewalwizard',
    padding: '2 0 2 0',
    requires: [
        ...
        this.tbar = {
            ...
            items: [
                
                {
                    ...
                    enableToggle: true,
                    pressed: true,
                    text: 'Document Application Renewal',
                    max_step:1,
                    action: 'quickNav', wizard: 'documentrenewalwizard',
        ...
        this.bbar = {
            ...
            items: [
                ...
                '->',
                {
                    ...
                    name: 'save', 
                   // formBind: true,
                    form_panel:'#docrenewalfrm',
                    action_url:'saveDocDefinationrequirement',
                    wizard: 'documentrenewalwizard',
                    handler: 'saveDocumentRenewalBaseDetails'
                },
                {
