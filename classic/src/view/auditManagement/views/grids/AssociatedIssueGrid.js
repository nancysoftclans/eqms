Ext.define("Admin.view.auditManagement.views.grids.AssociatedIssueGrid", {
  extend: "Ext.grid.Panel",
  controller: "auditMgmntVctr",
  xtype: "associatedissuegrid",
  itemId: "associatedissuegrid",
  ...
  tbar: [
    {
      xtype: "panel",
      html: "<h2>Double Click To Select</h2>",
    },
    {
      xtype: "exportbtn",
      hidden: true
