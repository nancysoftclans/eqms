Ext.define('Admin.view.widgets.SignaturePad',  {
    
    extend: 'Ext.Component',
    
    requires: ['Admin.view.widgets.Bezier', 'Admin.view.widgets.Point'],
    ...
    _createPoint: function(event) {
        ...
        return new Admin.view.widgets.Point(
    ...
    _addPoint: function(point) {
        ...
        if (points.length > 2) {
            ...
            c3 = tmp.c1;
            curve = new Admin.view.widgets.Bezier(points[1], c2, c3, points[2]);
    ...
    _calculateCurveControlPoints: function(s1, s2, s3) {
        ...
        return {
            c1: new Admin.view.widgets.Point(m1.x + tx, m1.y + ty),
            c2: new Admin.view.widgets.Point(m2.x + tx, m2.y + ty)
        };
    },
