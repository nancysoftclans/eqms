 ...
 */
Ext.define('Admin.view.documentsManagement.views.panels.DocumentApplicationReceivingWizard1', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.documentapplicationreceivingwizard1',
    padding: '2 0 2 0',
    requires: [
        ...
        this.tbar = {
            ...
            items: [
               
                {
                    ...
                    action: 'quickNav', wizard: 'documentapplicationreceivingwizard1',
