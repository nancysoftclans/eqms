 ...
 */
Ext.define('Admin.view.dashboard.grids.CorrespondenceGrid', {
    ...
    listeners:{
        beforerender: {
            ...
            config: {
                ...
                pageSize: 100,
                storeId: 'correspondenceGridStr',
                proxy: {
                   url: 'dashboard/getCorrespondence',
                }
            },
            isLoad: true
        }
    ...
    columns: [
        ...
        widget: {
            ...
            ui: 'soft-blue',
            name:'dispatch_correspondence',
            text: 'Dispatch Correspondence',
            handler: 'dispatchCorrespondence'
        }
    }
    ]
});