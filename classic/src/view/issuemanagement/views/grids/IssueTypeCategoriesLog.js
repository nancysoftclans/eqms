Ext.define('Admin.view.issuemanagement.views.grids.IssueTypeCategoriesLog', {
    extend: 'Ext.grid.Panel',
    xtype: 'issueTypeCategoriesLoggrid',
    itemId: 'issueTypeCategoriesLoggrid',
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                ...
                proxy: {
                    api: {
                        read: 'issuemanagement/getIssueTypeCategoriesLogs'
                    },
