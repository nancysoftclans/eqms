...
//     },
    ...
    getDocumentReleaseRecommendationDetails:function(btn){
        ...
        if(is_siginig ==1){
            hasApprovalRec = checkApprovalRecDetails(application_code, application_id);
            if(!hasApprovalRec){
        ...
        Ext.Ajax.request({
            ...
            success: function (response) {
                ...
                if (success == true || success === true) {
                    ...
                    funcShowCustomizableWindow('Document Approval Recommendation', '40%', form, 'customizablewindow');
                } else {
                    toastr.error(message, 'Failure Response');
                }
            },
...
*/
    ...
    saveDocumentReviewRecommendationDetails: function (btn) {
        var me = this,
            ...
            frm = form.getForm(),
            win = form.up('window'),
            action_url = 'documentmanagement/saveDocumentApplicationRecommendationDetails';
        if (frm.isValid()) {
            frm.submit({
                url: action_url,
                headers: {
...
if (sub_module_id) {
  ...
  showSelectedQueriesApplicationMoreDetails: function (btn,application_code,module_id,sub_module_id,section_id,prodclass_category_id,ref_no,application_id,applicant_id,process_id) {
    ...
    onNavigatorSelectionListDblClick: function (view, record, item, index, e, eOpts) {
        ...
        mask.show();
            var docdefinationrequirementfrm = activeTab.down('docdefinationrequirementfrm');
