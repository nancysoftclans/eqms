Ext.define("Admin.controller.SharedUtilitiesCtr", {
  ...
  control: {
    ...
    "documentreviewrecommfrm button[name=save_recommendation]": {
  ...
  listen: {
    controller: {
      "*": {
        ...
        funcUploadTCMeetingtechnicalDocuments:
          "funcUploadTCMeetingtechnicalDocuments",
        saveTCMeetingDetails: "saveTCMeetingDetails",
        showApplicationCommentsWin: "showApplicationCommentsWin",
        setReportApplicableChecklistComboStore:
          "setReportApplicableChecklistComboStore",
        showApplicationDismissalFormGeneric:
          "showApplicationDismissalFormGeneric",
        ...
        setConfigCombosStoreWithSectionFilter:
          "setConfigCombosStoreWithSectionFilter",
        previewApplicationProcessingTransitions:
          "previewApplicationProcessingTransitions",
        ...
        showSelectedQueriesApplicationMoreDetails:
          "showSelectedQueriesApplicationMoreDetails",
        progresSaveApplicationScreeningDetails:
          "progresSaveApplicationScreeningDetails",
        printFacilityInspectionReport: "printFacilityInspectionReport",
        printFacilityInspectionReportFromGrid:
          "printFacilityInspectionReportFromGrid",
  ...
  loadnotificationsReply: function (view, record) {
    ...
    childXtype
      .down("#userImage")
      .setSrc(base_url + "/resources/images/user-profile/" + senderProfile);
    if (!attachment) {
    } else {
      childXtype
        .down("#attachments")
        .setSrc(base_url + "/resources/images/user-profile/" + attachment);
    }
...
*/
      ...
      success: function (response) {
        ...
        if (success || success == true || success === true) {
          ...
          if (panel.down("displayfield[name=running_balance]")) {
            ...
            var payment_pnl = Ext.ComponentQuery.query(
              "#paymentspanelRefId"
            )[0];
            if (Ext.ComponentQuery.query("#paymentspanelRefId")[0]) {
              running_balance = payment_pnl.down(
                "displayfield[name=running_balance]"
              );
            }
          }
  ...
  generateApplicationReceipt: function (
    application_code,
    module_id,
    receipt_no
  ) {
    var action_url =
      "http://192.168.225.100:8009/home/receipt?receipt_no=" + receipt_no;
  ...
  showPaymentReceptionForm: function (btn) {
    ...
    Ext.MessageBox.confirm(
      "Confirm",
      "This option is only acceptable for Non Electronic payments as per the set guidelines. Do you want to continue?",
      function (button) {
        if (button === "yes") {
          Ext.getBody().mask("Please wait...");
          Ext.Ajax.request({
            ...
            success: function (response) {
              ...
              if (success == true || success === true) {
                if (!results) {
                  toastr.warning(
                    "Problem getting applicant details!!",
                    "Warning Response"
                  );
                  return false;
                }
                ...
                child
                  ...
                  .setValue(record.get("paying_currency_id"));
                funcShowCustomizableWindow(
                  title,
                  width,
                  child,
  ...
  saveApplicationPaymentDetails: function (btn) {
    var me = this,
      ...
      form = btn.up("form"),
      applicant_name = form
        .down("displayfield[name=applicant_name]")
        .getValue(),
  ...
  commitApplicationPayment: function (
    frm,
    url,
    table_name,
    application_code,
  ...
  showInvoicingApplicationSubmissionWin: function (btn) {
    ...
    var mainTabPanel = this.getMainTabPanel(),
      ...
      invoicepaymentverificationdetailsGrid = activeTab.down(
        "invoicepaymentverificationdetailsGrid"
      ),
      module_id = activeTab.down("hiddenfield[name=module_id]").getValue(),
      section_id = activeTab.down("hiddenfield[name=section_id]").getValue(),
    ...
    if (activeTab.down("invoicepaymentverificationdetailsGrid")) {
      ...
      if (store.getTotalCount() < 1) {
        toastr.warning(
          "The application doesnt have an Invoice, Please generate!!",
          "Warning Response"
        );
      ...
      if (store.getTotalCount() < 1) {
        toastr.warning(
          "The application doesnt have a Quote, Please generate!!",
          "Warning Response"
        );
        btn.setLoading(false);
        return false;
  ...
  showPaymentApplicationSubmissionWin: function (btn) {
    ...
    if (invoicepaymentverificationdetailsGrid.getStore().getTotalCount() < 1) {
      toastr.warning(
        "The application doesnt have an invoice, kindly contact the system Admin!!",
        "Warning Response"
      );
    } else {
  ...
  validatePaymentSubmission: function () {
    var mainTabPanel = this.getMainTabPanel(),
      ...
      application_id = activeTab
        .down("hiddenfield[name=active_application_id]")
        .getValue(),
      balance_str = activeTab
        .down("displayfield[name=running_balance]")
        .getValue(),
      balance = 0;
    if (balance_str) {
      ...
      if (parseFloat(bal) > 0) {
        toastr.warning(
          "The Application cannot be submitted until the applicant clears a balance of " +
            balance_str,
          "Warning Response"
        );
        return false;
  ...
  saveApplicationChecklistDetails: function (btn) {
    ...
    this.commitApplicationChecklistDetails(
      btn,
      application_id,
      application_code,
      screeningGrid
  ...
  commitApplicationChecklistDetails: function (
    btn,
    application_id,
    application_code,
    screeningGrid,
    ...
    var checklist_type = screeningGrid
  ...
  setWorkflowModuleGridsStore: function (grid) {
    ...
    if (isOnline && isOnline == 1) {
      storeConfig.config.proxy.url =
        "workflow/getOnlineProcessApplicableChecklistItems";
    }
    // else {
  ...
  showApplicationCommentsWin: function (btn) {
    var me = this,
      ...
      application_code = activeTab
        .down("hiddenfield[name=active_application_code]")
        .getValue();
    this.showApplicationCommentsGeneric(
      btn,
      application_id,
      application_code,
      workflow_stage_id
  ...
  showApplicationCommentsGeneric: function (
    item,
    application_id,
    application_code,
    workflow_stage_id
        ...
        success: function (response) {
          ...
          if (success == true || success === true) {
            ...
            activeTab
              ...
              .setValue(results.decision_id);
            activeTab
              .down("combo[name=recommendation_id]")
              .setValue(results.recommendation_id);
            activeTab
              .down("displayfield[name=workflow_stage]")
  ...
  showReceivingApplicationSubmissionWin: function (btn) {
    ...
    var mainTabPanel = this.getMainTabPanel(),
      ...
      validateHasDocuments =
        validateHasUploadedDocumentsDetils(application_code);
  ...
  showApplicationMoreDetails: function (btn) {
    ...
    if (module_id == 1) {
      this.showProductApplicationMoreDetailsGeneric(
        application_code,
        view,
        isReadOnly,
        "",
      ...
      var application_id = activeTab
        ...
        site_id = activeTab
          ...
          .getValue(),
        gmp_type_id = activeTab
          .down("hiddenfield[name=gmp_type_id]")
          .getValue();
      this.showGmpApplicationMoreDetailsGeneric(
        application_id,
        application_code,
        site_id,
        applicant_id,
      ...
      this.showPvApplicationMoreDetailsGeneric(
        application_code,
        "pvDetailsPnl",
        isReadOnly
      );
    } else if (module_id == 22) {
      this.showMirApplicationMoreDetailsGeneric(
        application_code,
        "mirDetailsPnl",
        isReadOnly
      );
    } else if (module_id == 25) {
      this.showPsurApplicationMoreDetailsGeneric(
        application_code,
        "psurDetailsPnl",
        isReadOnly
      );
    } else if (module_id == 24) {
      this.showRMUApplicationMoreDetailsGeneric(
        application_code,
        "rmuSubmissionDetailsPnl",
        isReadOnly
      );
    } else if (module_id == 8) {
      if (sub_module_id == 88) {
        this.showMonitoringApplicationMoreDetailsGeneric(
          application_code,
          "monitoringDetailsPnl",
          module_id,
          sub_module_id,
          section_id,
          isReadOnly
        ...
        this.showEnforcementApplicationMoreDetailsGeneric(
          application_code,
          "operationDetailsPnl",
          module_id,
          sub_module_id,
        ...
        joint_investigation_id = activeTab
          .down("hiddenfield[name=joint_investigation_id]")
          .getValue();

        if (joint_investigation_id) {
          this.showJointReportInvestigationMoreDetailsGeneric(
            application_code,
            "jointInvestigationDetails",
            module_id,
            sub_module_id,
            section_id,
            isReadOnly
      ...
      this.showClinicalTrialApplicationMoreDetailsGeneric(
        application_id,
        application_code,
        applicant_id,
        ref_no,
      ...
      var premise_id = activeTab
        .down("hiddenfield[name=premise_id]")
        .getValue();
      this.showPremiseApplicationMoreDetailsGeneric(
        application_id,
        premise_id,
        applicant_id,
        ref_no,
      ...
      this.showPromotionMaterialApplicationMoreDetailsGeneric(
        application_id,
        application_code,
        applicant_id,
        ref_no,
      ...
      this.showPermitApplicationMoreDetailsGeneric(
        "previewAmmendimportexportpermitdetails",
        application_id,
        applicant_id,
        ref_no,
        process_id,
      ...
      this.showPermitApplicationMoreDetailsGeneric(
        "previewimportexportpermitdetails",
        application_id,
        applicant_id,
        ref_no,
        process_id,
      ...
      this.showPermitApplicationMoreDetailsGeneric(
        "previewcontroldrugsimppermitdetails",
        application_id,
        applicant_id,
        ref_no,
        process_id,
      ...
      if (sub_module_id == 98) {
        this.showAdvancedCustomerApplicationMoreDetailsGeneric(
          application_code,
          "advancedCustomerDetailsPnl",
          module_id,
          sub_module_id,
          section_id,
          isReadOnly
        ...
        this.showInvoicesRefundApplicationMoreDetailsGeneric(
          application_code,
          "revenueRefundApplicationDetailsPnl",
          module_id,
          sub_module_id,
          section_id,
          isReadOnly
  ...
  showProductApplicationMoreDetailsGeneric: function (
    application_code,
    productdetails_panel,
    isReadOnly,
    ref_no,
    workflow_stage_id
  ) {
      ...
      success: function (response) {
        ...
        if (success == true || success === true) {
          ...
          if (prodclass_category_id == 50) {
            ...
            productdetails_panel.add(0, {
              title: "Pharmacist(Applicant)",
              xtype: "productapplicantdetailsfrm",
            });
          } else if (prodclass_category_id == 51) {
            productdetails_panel.add(0, {
              title: "Practitioner Details",
              xtype: "exmpProductsDetailsFrm",
            });
          } else if (prodclass_category_id == 47) {
            productdetails_panel.add(0, {
              title:
                "Application on behalf of the Animal Holding Unit (Farm or Homestead)",
              xtype: "animalHoldingUnitGrid",
            });
            productdetails_panel.add(0, {
              title:
                "PRESCRIBER/ APPLICANT Details (Veterinary Surgeon or Paraprofessional)",
              xtype: "exmpProductsDetailsFrm",
            });
          } else if (prodclass_category_id == 48) {
            productdetails_panel.add(0, {
              title:
                "Practitioner/ Applicant (RESPONSIBLE PERSON [Pharmacist / Veterinary Surgeon or Principal Investigator)",
              xtype: "exmpProductsDetailsFrm",
            });
          ...
          if (!products_form) {
            //loads after added forms intop if the original view had no form
            products_form = productdetails_panel.down("form");
          }
          funcShowStatelessCustomizableWindow(
            ref_no,
            "85%",
            productdetails_panel,
            "customizablewindow"
          ...
          if (product_details) {
            ...
            if (productdetails_panel.down("productapplicantdetailsfrm")) {
              productdetails_panel
                .down("productapplicantdetailsfrm")
                .loadRecord(model2);
              applicant_form = productdetails_panel.down(
                "productapplicantdetailsfrm"
              );
              applicant_form
                .down("hiddenfield[name=applicant_id]")
                .setValue(applicant_id_no);
            }
            if (productdetails_panel.down("exmpProductsDetailsFrm")) {
              productdetails_panel
                .down("exmpProductsDetailsFrm")
                .loadRecord(model2);
            }
            var model3 = Ext.create("Ext.data.Model", ltrDetails);
            if (productdetails_panel.down("productlocalapplicantdetailsfrm")) {
              productdetails_panel
                .down("productlocalapplicantdetailsfrm")
                .loadRecord(model3);
            }
          }
          ...
          if (isReadOnly == 1) {
            ...
            isReadOnly == 0 &&
            (workflow_stage_id == 402 || workflow_stage_id === 403)
          ) {
  ...
  showGmpApplicationMoreDetailsGeneric: function (
    application_id,
    application_code,
    site_id,
    applicant_id,
    ...
    var me = this,
      ...
      gmpProductDetailsGrid = wizardPnl.down(
        "gmpproductslinkagedetailswingrid"
      ),
      blocksGrid = wizardPnl.down("mansiteblockdetailswingrid"),
      assessmentType_fld = wizardPnl.down("combo[name=assessment_type_id]"),
      assessment_procedure_id_fld = wizardPnl.down(
        "combo[name=assessment_procedure_id]"
      ),
    ...
    if (section_id == 4) {
      wizardPnl
        .down("button[name=line_details]")
        .setText("DEVICE TYPE DETAILS");
      ...
      productLineDetailsGrid
        .down("button[name=add_line]")
        .setText("Add Device Type");
    ...
    if (sub_module_id == 40 || sub_module_id === 40) {
      wizardPnl
        .down("gmpvariationrequestsgrid")
        .down("hiddenfield[name=isReadOnly]")
        .setValue(siteReadOnly);
    }
    Ext.Ajax.request({
      method: "GET",
      ...
      success: function (response) {
        ...
        if (success == true || success === true) {
          if (applicantDetails) {
            ...
            assessment_procedure_id_fld.setValue(
              applicantDetails.assessment_procedure_id
            );
          }
          if (siteDetails) {
      ...
      frm.submit({
        ...
        success: function (fm, action) {
          var response = Ext.decode(action.response.responseText),
            ...
            message = response.message;
          if (success == true || success === true) {
            if (activeTab.down("combo[name=approval_id]")) {
              activeTab.down("combo[name=approval_id]").setValue(decision_id);
            } else {
              mainStore.load();
            }
            toastr.success(message, "Success Response");
  ...
  showPromotionMaterialApplicationMoreDetailsGeneric: function (
    application_id,
    application_code,
    applicant_id,
    ref_no,
    ...
    var me = this,
      ...
      promotiommaterialproductgrid = wizardPnl.down(
      ...
      promotionmaterialdetailsgrid = wizardPnl.down(
  ...
  addAuthSignature: function (btn) {
    ...
    Ext.Ajax.request({
      ...
      success: function (response) {
        ...
        if (success == true || success === true) {
          toastr.success(
            "Sign request successfully submitted the status will change once signed",
            "Success Response"
          );
          mainStore.load();
  ...
  funcUploadTCMeetingtechnicalDocuments: function (btn) {
    ...
    if (meeting_id != "") {
      childXtype
        .down("hiddenfield[name=document_type_id]")
        .setValue(document_type_id);
      childXtype
        .down("hiddenfield[name=reference_record_id]")
        .setValue(meeting_id);
      childXtype.down("hiddenfield[name=table_name]").setValue(table_name);
      childXtype
        .down("hiddenfield[name=reference_table_name]")
        .setValue(reference_table_name);
      funcShowCustomizableWindow(
        winTitle,
        winWidth,
        childXtype,
  ...
  addApplicationWorkflowParams: function (me) {
    var store = me.store,
      ...
      section_id = activeTab.down("hiddenfield[name=section_id]").getValue(),
      module_id = activeTab.down("hiddenfield[name=module_id]").getValue(),
      gmp_type_id = activeTab.down("combo[name=gmp_type_id]")
        ? activeTab.down("combo[name=gmp_type_id]").getValue()
        : null,
      region_id = activeTab.down("combo[name=region_id]")
        ? activeTab.down("combo[name=region_id]").getValue()
        : null,
      premise_type_id = activeTab.down("hiddenfield[name=premise_type_id]")
        ? activeTab.down("hiddenfield[name=premise_type_id]").getValue()
        : "",
  ...
  refreshunstructureddocumentuploadsgrid: function (me) {
    var store = me.store,
      ...
      reference_record_id = grid
        .down("hiddenfield[name=reference_record_id]")
        .getValue(),
      document_type_id = grid
        .down("hiddenfield[name=document_type_id]")
        .getValue();
  ...
  showUnstructuredDocUploadWin: function (btn) {
    var childXtype = btn.childXtype,
      ...
      reference_record_id = grid
        .down("hidden[name=reference_record_id]")
        .getValue(),
      reference_table_name = grid
        .down("hidden[name=reference_table_name]")
        .getValue(),
      storeID = grid.storeID,
      form = Ext.widget(childXtype);
  ...
  addChecklistListApplicationFilters: function (me) {
    var store = me.store,
      ...
      workflow_stage_id = activepanel
        .down("hidden[name=workflow_stage_id]")
        .getValue(),
  ...
  showApplicationDismissalForm: function () {
    var childObject = Ext.widget("applicationdismissalfrm"),
      ...
      workflow_stage_id = activeTab
        .down("hiddenfield[name=workflow_stage_id]")
        .getValue();
    this.showApplicationDismissalFormGeneric(
      tracking_no,
      application_id,
      application_code,
      module_id,
  ...
  showApplicationDismissalFormGeneric: function (
    ref_no,
    application_id,
    application_code,
    module_id,
  ...
  showRMUApplicationMoreDetailsGeneric: function (
    application_code,
    details_panel,
    isReadOnly,
    ref_no
  ...
  showMirApplicationMoreDetailsGeneric: function (
    application_code,
    details_panel,
    isReadOnly,
    ref_no
  ...
  showEnforcementApplicationMoreDetailsGeneric: function (
    application_code,
    details_panel,
    module_id,
    sub_module_id,
    ...
    Ext.Ajax.request({
      ...
      success: function (response) {
        ...
        if (success == true || success === true) {
          ...
          jointOperationsWorkPlanFrm = details_panel.down(
            "jointOperationsWorkPlanFrm"
          );
  ...
  showMonitoringApplicationMoreDetailsGeneric: function (
    application_code,
    details_panel,
    module_id,
    sub_module_id,
    ...
    Ext.Ajax.request({
      ...
      success: function (response) {
        ...
        if (success == true || success === true) {
          ...
          complianceinformationtabPnl = details_panel.down(
            "complianceinformationtabPnl"
          );
  ...
  showPvApplicationMoreDetailsGeneric: function (
    application_code,
    details_panel,
    isReadOnly,
    ref_no
  ...
  showClinicalTrialApplicationMoreDetailsGeneric: function (
    application_id,
    application_code,
    applicant_id,
    ref_no,
    ...
    var me = this,
      ...
      investigatorsWinGrid = wizardPnl.down(
        "clinicaltrialotherinvestigatorsgrid"
      ),
      clinicaltrialotherformdetailsfrm = wizardPnl.down(
        "clinicaltrialotherformdetailsfrm"
      ),
      previewproductDocUploadsGrid = wizardPnl.down(
    ...
    investigatorsWinGrid
      .down("hiddenfield[name=isReadOnly]")
      .setValue(isReadOnly);
    if (isReadOnly && (isReadOnly == 1 || isReadOnly === 1)) {
      wizardPnl.down("button[name=save_btn]").setVisible(false);
      wizardPnl
        .down("button[name=save_clinicaltrial_details_btn]")
        .setVisible(false);
    }
  ...
  refreshCtrvariationrequestsgrid: function (me) {
    ...
    if (grid.up("window")) {
      if (grid.down("hiddenfield[name=application_id]")) {
        ...
        application_code = activeTab.down(
          "hiddenfield[name=active_application_code]"
        )
          ? activeTab
              .down("hiddenfield[name=active_application_code]")
              .getValue()
  ...
  refreshCtrvariationEthicsrequestsgrid: function (me) {
    ...
    if (grid.up("window")) {
      if (grid.down("hiddenfield[name=application_id]")) {
        ...
        application_id = activeTab.down(
          "hiddenfield[name=active_application_id]"
        )
          ? activeTab.down("hiddenfield[name=active_application_id]").getValue()
          : null;
        // application_id = grid.down('hiddenfield[name=application_id]').getValue();
        // application_code = grid.down('hiddenfield[name=application_code]').getValue();
        filters = JSON.stringify({ application_id: application_id });
  ...
  refreshApplicationAmmendementrequestsgrid: function (me) {
    var store = me.store,
      ...
      application_code = grid
        .down("hiddenfield[name=application_code]")
        .getValue(),
      appdata_ammendementrequest_id = grid
        .down("hiddenfield[name=appdata_ammendementrequest_id]")
        .getValue(),
      application_id = grid.down("hiddenfield[name=application_id]").getValue();
  ...
  showPremiseApplicationMoreDetailsGeneric: function (
    application_id,
    applicant_id,
    ref_no,
    process_id,
    ...
    var me = this,
      ...
      premiseproprietorsdetailsgrid = wizardPnl.down(
      ...
      success: function (response) {
        ...
        if (success == true || success === true) {
          if (wizardPnl.down("hiddenfield[name=premise_type_id]")) {
            wizardPnl
              .down("hiddenfield[name=premise_type_id]")
              .setValue(premiseDetails.premise_type_id);
            // console.log('here');
          }
          if (applicantDetails) {
            var model1 = Ext.create("Ext.data.Model", applicantDetails);
  ...
  loadMeetingInterface: function (rec) {
    var mainTabPanel = this.getMainTabPanel(),
      ...
      viewscheduledtcmeetingapplications = activeTab.down(
        "panel[name=viewscheduledtcmeetingapplications]"
      );

    activeTab
      .down("hiddenfield[name=active_application_id]")
      .setValue(rec.get("application_id"));
    activeTab
      .down("hiddenfield[name=active_application_code]")
      .setValue(rec.get("application_code"));
    activeTab
      .down("hiddenfield[name=process_id]")
      .setValue(rec.get("process_id"));
    activeTab
      .down("hiddenfield[name=workflow_stage_id]")
      .setValue(rec.get("workflow_stage_id"));
    activeTab
      .down("hiddenfield[name=application_status_id]")
      .setValue(rec.get("application_status_id"));
    activeTab
      .down("hiddenfield[name=module_id]")
      .setValue(rec.get("module_id"));
    activeTab
      .down("hiddenfield[name=sub_module_id]")
      .setValue(rec.get("sub_module_id"));
    activeTab
      .down("hiddenfield[name=section_id]")
      .setValue(rec.get("section_id"));
    activeTab
      .down("displayfield[name=process_name]")
      .setValue(rec.get("process_name"));
    activeTab
      .down("hiddenfield[name=meeting_id]")
      .setValue(rec.get("meeting_id"));
    activeTab
      .down("hiddenfield[name=prodclass_category_id]")
      .setValue(rec.get("prodclass_category_id"));
  ...
  setSelectedGridRecToTab: function (rec) {
    ...
    activeTab
      .down("displayfield[name=workflow_stage]")
      .setValue(rec.get("workflow_stage"));
    activeTab
      .down("displayfield[name=application_status]")
      .setValue(rec.get("application_status"));
    activeTab
      .down("displayfield[name=tracking_no]")
      .setValue(rec.get("tracking_no"));
    activeTab
      .down("displayfield[name=reference_no]")
      .setValue(rec.get("reference_no"));
          ...
          Ext.each(records, function (record) {
            ...
            if (is_field) {
              ...
              var apprvBtn = Ext.create("Ext.button.Button", {
                ...
                handler:
                  decision_id == 1
                    ? "alertOnDoubleApproval"
                    : "approveVariationField",
              });
            ...
            //when its a grid data change
              ...
              if (xtype == "premisecontactpersonfrm") {
                thisController.loadContactPersonDetails(
                  view,
                  application_code,
                  module_id
                );
  ...
  approveVariationField: function (btn) {
    ...
    child
      .down("hiddenfield[name=variation_type_id]")
      .setValue(variation_type_id);
    if (btn.decision_id) {
  ...
  showApplicationQueries: function (item) {
    ...
    childItem
      ...
      .setValue(product_origin_id);
    childItem
      .down("hiddenfield[name=application_status_id]")
      .setValue(application_status_id);
    childItem
      .down("hiddenfield[name=is_manager_query_response]")
      .setValue(is_manager_query_response);
    funcShowCustomizableWindow(
      ref_no + " QUERIES",
      "85%",
      childItem,
        ...
        if (success == true || success === true) {
          if (permit_details) {
            ...
            if (permitsdetails_panel.down("combo[name=branch_id]")) {
              permitsdetails_panel
                .down("combo[name=branch_id]")
                .setValue(permit_details.branch_id);
            }
          }
          ...
          if (permit_details.module_id == 20) {
            docsGrid = permitsdetails_panel.down(
              "declaredimportexportdocuploadsgrid"
            );
          } else {
            docsGrid = permitsdetails_panel.down(
          ...
          if (docsGrid.down("hiddenfield[name=importexport_permittype_id]")) {
            docsGrid
              .down("hiddenfield[name=importexport_permittype_id]")
              .setValue(permit_details.importexport_permittype_id);
          }
          if (permitsdetails_panel.down("#variationrequestsgrid")) {
            if (
              permitsdetails_panel
                .down("#variationrequestsgrid")
                .down("hiddenfield[name=application_code]")
            ) {
              permitsdetails_panel
                .down("#variationrequestsgrid")
  ...
  previewInspectionDetails: function (application_id) {
    ...
    funcShowCustomizableWindow(
      "Inspection Preview",
      "60%",
      inspectionPreviewPnl,
      "customizablewindow"
    );
  },
  showProductRegisterApplicationsMoreDetails: function (
    btn,
    application_code,
    module_id,
    sub_module_id,
  ...
  showSelectedReportDetails: function (
    btn,
    application_code,
    module_id,
    sub_module_id,
    ...
    var isReadOnly = btn.isReadOnly,
      ...
      mainTabPanel = this.getMainTabPanel(),
      activeTab = mainTabPanel.getActiveTab();
    this.showEnforcementSelectedReportDetails(
      application_code,
      "enforcementDetailsPnl",
      module_id,
      sub_module_id,
  ...
  showEnforcementSelectedReportDetails: function (
    application_code,
    details_panel,
    module_id,
    sub_module_id,
  ...
  showJointOperationRegisterMoreDetails: function (
    btn,
    application_code,
    module_id,
    sub_module_id,
    ...
    var isReadOnly = btn.isReadOnly,
      ...
      mainTabPanel = this.getMainTabPanel(),
      activeTab = mainTabPanel.getActiveTab();
    this.showJointOperationMoreDetails(
      application_code,
      "operationDetailsPnl",
      module_id,
      sub_module_id,
  ...
  showJointOperationMoreDetails: function (
    application_code,
    details_panel,
    module_id,
    sub_module_id,
  ...
  showJointReportInvestigationMoreDetailsGeneric: function (
    application_code,
    details_panel,
    module_id,
    sub_module_id,
  ...
  showAdvancedCustomerApplicationMoreDetailsGeneric: function (
    application_code,
    details_panel,
    module_id,
    sub_module_id,
  ...
  showInvoicesRefundApplicationMoreDetailsGeneric: function (
    application_code,
    details_panel,
    module_id,
    sub_module_id,
  ...
  showAdvancedCustomerRegisterMoreDetails: function (
    btn,
    application_code,
    module_id,
    sub_module_id,
  ...
  showPromotionRegisterMoreDetails: function (
    application_id,
    application_code,
    applicant_id,
    ref_no,
  ...
  showMonitoringRegisterMoreDetails: function (
    application_code,
    view,
    module_id,
    sub_module_id,
  ...
  getRevenueTotal: function (pnl) {
    var cont = pnl.up("advancedCustomerLedgerPnl"),
      applicant_id,
      date_from,
      date_to;
    ...
    if (applicant_id) {
      cont
        .down("cartesian")
        .getStore()
        .reload({ params: { applicant_id: applicant_id } });
    }
    ...
    Ext.Ajax.request({
      ...
      success: function (response) {
        ...
        if (success == true || success === true) {
          pnl
            .down("displayfield[name=total_receivables]")
            .setValue(total_receivables);
          pnl
            .down("displayfield[name=total_payables]")
            .setValue(total_payables);
          pnl
            .down("displayfield[name=account_balance]")
            .setValue(account_balance);
        } else {
          toastr.error(message, "Failure Response");
        }
      },
  ...
  showApprovalInspectionApplicationSubmissionWin: function (btn) {
    ...
    showWorkflowSubmissionWin(
      ...
      application_code,
      table_name,
      "workflowsubmissionsinspectionsfrm",
      winWidth,
      storeID,
      "",
      "",
  ...
  showPsurApplicationMoreDetailsGeneric: function (
    application_code,
    details_panel,
    isReadOnly,
    ref_no
      ...
      success: function (response) {
        ...
        if (success == true || success === true) {
          (psurdetailsFrm = details_panel.down("psurdetailsFrm")),
            (productapplicantdetailsfrm = details_panel.down(
              "productapplicantdetailsfrm"
            )),
            (productlocalapplicantdetailsfrm = details_panel.down(
              "productlocalapplicantdetailsfrm"
            )),
            funcShowCustomizableWindow(
              ref_no,
              "85%",
  ...
  receiveOnlineApplicationDetailsFrmBtn: function (btn) {
    ...
    if (!hasQueries) {
      //skip some modules
      if (is_invoicecheck) {
        invoiceIsGenerated = checkGeneratedInvoiceDetails(
          application_code,
          module_id,
          sub_module_id,
          section_id
        ...
        if (!invoiceIsGenerated) {
          toastr.warning(
            "Receive and Generate Invoice, to proceed!!",
            "Warning Response"
          );
          Ext.getBody().unmask();
          return false;
    ...
    if (win.down("button[name=prechecking_recommendation]")) {
      hasPrecheckingrecommendation = checkPrecheckingrecommendation(
        application_code,
        module_id
      );
      if (!hasPrecheckingrecommendation) {
        toastr.warning(
          "Add Prechecking Recommendation to proceed.",
          "Warning Response"
        );
        Ext.getBody().unmask();
        return false;
    ...
    showOnlineSubmissionWin(
      application_id,
      application_code,
      module_id,
      sub_module_id,
      section_id,
      "onlinesubmissionsfrm",
      winWidth,
      storeID,
      tracking_no,
      status_type_id,
  ...
  receiveAndInvoiceOnlineApplicationDetailsFrmBtn: function (btn) {
    ...
    if (invoiceIsGenerated) {
      toastr.warning(
        "Invoice has already been generated, print and submit!!",
        "Warning Response"
      );
      Ext.getBody().unmask();
      return false;
    ...
    if (!hasQueries) {
      if (win.down("combo[name=applicable_checklist]")) {
        checklist_category_id = win
          .down("combo[name=applicable_checklist]")
          .getValue();
        hasValidatedChecklist = checkOnlineApplicationChecklistDetails(
          application_code,
          module_id,
          sub_module_id,
          section_id,
        ...
        if (!hasValidatedChecklist) {
          toastr.warning(
            "Fill in all the checklist details to proceed!!",
            "Warning Response"
          );
          Ext.getBody().unmask();
          return false;
      ...
      showreceiveAndInvoiceOnlineApplicationDetails(
        application_id,
        application_code,
        module_id,
        sub_module_id,
        section_id,
        "onlineapplicationreceiceinvoicefrm",
        winWidth,
        storeID,
        tracking_no,
        status_type_id,
      ...
      toastr.warning(
        "The Application has a pending query, close the query or submit to the Manager(Query Process) !!",
        "Warning Response"
      );
      Ext.getBody().unmask();
      return false;
  ...
  receiveOnlineApplicationDetails: function (btn) {
    var mainTabPanel = this.getMainTabPanel(),
      ...
      onlineappssubmissioncounterstr = Ext.getStore(
        "onlineappssubmissioncounterstr"
      ),
  ...
  showProductPortalApplicationMoreDetailsGeneric: function (
    application_code,
    productdetails_panel,
    isReadOnly,
    ref_no
  ...
  showProductRegisterPortalApplicationsMoreDetails: function (
    btn,
    application_code,
    module_id,
    sub_module_id,
    ...
    if (module_id == 1) {
      this.showProductPortalApplicationMoreDetailsGeneric(
        application_code,
        view,
        isReadOnly,
        ref_no
  ...
  onMeetingGroupSelectionListDblClick: function (
    view,
    record,
    item,
    index,
  ...
  showSelectedQueriesApplicationMoreDetails: function (
    btn,
    application_code,
    module_id,
    sub_module_id,
    ...
    if (module_id == 1) {
      ...
      this.showGmpQueriesApplicationMoreDetailsGeneric(
        application_id,
        application_code,
        applicant_id,
        ref_no,
  ...
  showGmpQueriesApplicationMoreDetailsGeneric: function (
    application_id,
    application_code,
    applicant_id,
    ref_no,
  ...
  updateProductReviewBaseDetails: function (btn) {
    var mainTabPanel = this.getMainTabPanel(),
      activeTab = mainTabPanel.getActiveTab();
    if (
      activeTab.xtype != "productRegisterPnl" &&
      activeTab.xtype != "listedCosmeticsRegisterPnl" &&
      activeTab.xtype != "listedDevicesRegisterPnl"
    ) {
      var process_id = activeTab
          .down("hiddenfield[name=process_id]")
          .getValue(),
        sub_module_id = activeTab
          .down("hiddenfield[name=sub_module_id]")
        ...
        applicant_id = activeTab
          .down("hiddenfield[name=applicant_id]")
          .getValue(),
        local_applicant_id = activeTab
          .down("hiddenfield[name=local_applicant_id]")
          .getValue(),
        product_id = activeTab.down("hiddenfield[name=product_id]").getValue(),
        is_register_update = "";
    } else {
    ...
    productDetailsForm
      .down("hiddenfield[name=product_id]")
      .setValue(product_id);
