...
if (!function_exists('funcEncrypt')) {
    ...
    {
        return SecurityHelper::funcEncrypt($plainText);
    }
}

if (!function_exists('funcDecrypt')) {
    function funcDecrypt($cipher)
    {
        return SecurityHelper::funcDecrypt($cipher);
    }
}

if (!function_exists('decryptUserCollection')) {
    function decryptUserCollection($userCol)
    {
        return SecurityHelper::decryptUserCollection($userCol);
    }
}
if (!function_exists('getDecryptFunParams')) {
    function getDecryptFunParams()
    {
        return SecurityHelper::getDecryptFunParams();
    }
}
...
if (!function_exists('convertArrayToString')) {
    ...
    {
        return UtilityHelper::convertArrayToString($array);
    }
}
...
if (!function_exists('insertRecord')) {
    function insertRecord($table_name, $table_data, $user_id = null, $con = 'pgsql')
    {
...
if (!function_exists('updateRecord')) {
    function updateRecord($table_name, $where, $table_data, $user_id=null, $con = 'pgsql')
    {
...
if (!function_exists('deleteRecord')) {
    function deleteRecord($table_name, $where_data, $user_id = null, $con = 'pgsql')
    {
...
if (!function_exists('getUserNotificationsCounter')) {
    function getUserNotificationsCounter($user_id)
    {
        return UtilityHelper::getUserNotificationsCounter($user_id);
    }
}
...
if (!function_exists('generateApplicationTrackingNumber')) {
    function generateApplicationTrackingNumber($sub_module_id, $reference_type_id, $codes_array, $section_id, $process_id, $zone_id, $user_id, $is_refno = false)
    {
        return UtilityHelper::generateApplicationTrackingNumber($sub_module_id, $reference_type_id, $codes_array, $section_id, $process_id, $zone_id, $user_id, $is_refno);
    }
}
...
if (!function_exists('generateApplicationCode')) {
    function generateApplicationCode($module_id, $table_name, $con='pgsql')
    {
...
if (!function_exists('updateApplicationQueryRef')) {
    function updateApplicationQueryRef($application_id, $application_code, $ref_no, $user_id, $module_id, $table_name = '', $remark = '')
    {
        UtilityHelper::updateApplicationQueryRef($application_id, $application_code, $ref_no, $user_id, $module_id, $table_name, $remark);
    }
}
...
if (!function_exists('loginDMS')) {
    function loginDMS($user, $password)
    {
        return DMSHelper::loginDMS($user, $password);
...
if (!function_exists('getApplicationSubModuleNodeDetails')) {
    function getApplicationSubModuleNodeDetails($section_id, $module_id, $sub_module_id, $user_id, $con = 'pgsql')
    {
...
if (!function_exists('saveApplicationDocumentNodedetails')) {
    function saveApplicationDocumentNodedetails($module_id, $sub_module_id, $application_code, $tracking_no, $reference_no, $dms_node_id, $user, $con = 'pgsql')
    {
...
if (!function_exists('notifyGroupUsers')) {
    function notifyGroupUsers($template_id, $workflow_stage_id, $vars = array())
    {
        EmailHelper::notifyGroupUsers($template_id, $workflow_stage_id, $vars);
    }
}
...
if (!function_exists('addCustomerToSAP')) {
    function addCustomerToSAP($applicant_id)
    {
        return UtilityHelper::addCustomerToSAP($applicant_id);
    }
}
...
//funcSaveOnlineControlledDrugsOtherdetails
if (!function_exists('funcSaveOnlineControlledDrugsOtherdetails')) {
    function funcSaveOnlineControlledDrugsOtherdetails($application_code, $user_id)
    {
        return UtilityHelper::funcSaveOnlineControlledDrugsOtherdetails($application_code, $user_id);
    }
}
//funcSaveOnlineImportExportOtherdetails
...
if (!function_exists('_suspensionReasons')) {
    function _suspensionReasons($application_code)
    {
        return DbHelper::_suspensionReasons($application_code);
    }
}
...
if (!function_exists('applicationExpiryNotificationMail')) {
    function applicationExpiryNotificationMail($template_id, $email, $applicant, $vars = array())
    {
        return EmailHelper::applicationExpiryNotificationMail($template_id, $email, $applicant, $vars);
    }
}
...
if (!function_exists('onSaveOfflinePrePayments')) {
    function onSaveOfflinePrePayments($application_code, $req, $user_name)
    {
        return DbHelper::onSaveOfflinePrePayments($application_code, $req, $user_name);
    }
}
if (!function_exists('getTraderEmail')) {
    function getTraderEmail($applicant_id)
    {
        return UtilityHelper::getTraderEmail($applicant_id);
    }
}
//new
if (!function_exists('insertMultipleRecords')) {
    function insertMultipleRecords($table_name, $table_data, $user_id = null, $con = 'pgsql')
    {

        return DbHelper::insertMultipleRecords($table_name, $table_data, $user_id, $con);
    }
}
if (!function_exists('getApplicationCurrentStageDetails')) {
    function getApplicationCurrentStageDetails($module_id, $application_code)
    {

        return DbHelper::getApplicationCurrentStageDetails($module_id, $application_code);
    }
}
...
if (!function_exists('array_flatten')) {
    ...
    {
        return UtilityHelper::array_flatten($arr);
    }
}
if (!function_exists('updateFacilityRiskScore')) {
    function updateFacilityRiskScore()
    {
        return DbHelper::updateFacilityRiskScore();
    }
}
...
if (!function_exists('postRequest')) {
    ...
    {
        return IntegrationHelper::postRequest($data);
    }
}

if (!function_exists('getInternalApplicant_id')) {
    function getInternalApplicant_id($identification_no)
    {
