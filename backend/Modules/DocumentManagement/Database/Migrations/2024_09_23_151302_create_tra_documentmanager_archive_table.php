...
class CreateTraDocumentmanagerArchiveTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tra_documentmanager_archive', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tra_documentmanager_archive');
    }
}
