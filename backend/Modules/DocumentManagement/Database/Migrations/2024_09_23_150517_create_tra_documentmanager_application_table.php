...
class CreateTraDocumentmanagerApplicationTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tra_documentmanager_application', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('doc_version', 50)->nullable();
            $table->string('document_number', 50)->nullable();
            $table->integer('navigator_folder_id')->nullable();
            $table->integer('applicant_id')->nullable();
            $table->string('view_id', 50)->nullable();
    ...
    {
        Schema::dropIfExists('tra_documentmanager_application');
    }
}
